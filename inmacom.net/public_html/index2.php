        ...
        <div class="card card-crypto">
          <div class="card-header pd-y-8 d-sm-flex align-items-center justify-content-between">
            ...
            <ul class="nav nav-line" id="myTab5" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="quality" data-toggle="tab" href="#home3" role="tab" aria-controls="contact" aria-selected="false">RAINFALL</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="quality" data-toggle="tab" href="#home3" role="tab" aria-controls="contact" aria-selected="false">GROUNDWATER</a>
              </li>
            </ul>
          ...
          <div class="card-body pd-10">
            <div class="tab-content" id="myTabContent5">
              <div class="tab-pane fade show active" id="home1" role="tabpanel" aria-labelledby="home-tab5">
                <div id="leaflet1" class="ht-400"></div>
              </div>
              <div class="tab-pane fade" id="home2" role="tabpanel" aria-labelledby="profile-tab5">
          ...
          if (type == "success") {
            ...
            for (var i = 0; i < data.length; i++) {
              ...
              var popupContent = `<h5 class = "text-primary text-center">${data[i].name}</h5>
                ...
                <tbody><tr><td> Station: </td><td>( ${data[i].code} ) ${data[i].name}</td></tr>
          ...
          success: function(response) {
            ...
            if (type == "success") {
              ...
              for (var i = 0; i < data.length; i++) {
                ...
                var popupContent = `<h5 class = "text-primary text-center">${data[i].name}</h5>
                <div class="container"><table class="table table-hover">
                <tbody><tr><td> Dam: </td><td>( ${data[i].code} ) ${data[i].name}</td></tr>
                <tr><td> Latitude: </td><td>${data[i].latitude}</td></tr>
                <tr><td> Longitude: </td><td>${data[i].longitude}</td></tr>
