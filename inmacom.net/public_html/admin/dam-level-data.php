...
<body>
          ...
          <div>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                ...
                <li class="breadcrumb-item active" aria-current="page">Dam Levels</li>
              </ol>
            </nav>
            <h4 class="mg-b-0 tx-spacing--1">Historic Dam Level Data</h4>
          </div>
  ...
  <script>
    ...
    var table = 'dam_levels';
    var category = 'Dam Levels';
    var label_text = 'Daily Storage (%)';
        ...
        var dataTable = $('#flow_level').DataTable({
            ...
            "drawCallback": function(settings) {
                ...
                for (var count = 0; count < settings.aoData.length; count++) {
                    ...
                    var dataValue = parseFloat(settings.aoData[count]._aData[1]);
                    var color;
                    ...
                    } else if (dataValue > 80 && dataValue <= 100) {
                        color = 'rgb(51, 153, 255)';
                ...
                var chart_data = {
                    ...
                    datasets: [{
                        ...
                        borderColor: lineColors, // Set line colors here
                        borderWidth: 2,
                        data: sale
                    }]
                };
