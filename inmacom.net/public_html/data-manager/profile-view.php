...
<body class="page-profile">
  ...
  <header class="navbar navbar-header navbar-header-fixed">
    ...
    <div class="navbar-brand">
      <a href="./index-2.html" class="df-logo">dash<span>forge</span></a>
    </div><!-- navbar-brand -->
    ...
    <div class="navbar-search">
      ...
      <div class="navbar-search-body">
        ...
        <ul class="list-unstyled">
          <li><a href="dashboard-one.php">modern dashboard</a></li>
          <li><a href="app-calendar.php">calendar app</a></li>
          <li><a href="./collections/modal.php">modal examples</a></li>
          <li><a href="./components/el-avatar.php">avatar</a></li>
        </ul>
        ...
        <ul class="list-unstyled">
          <li><a href="dashboard-one.php">cryptocurrency</a></li>
          <li><a href="app-calendar.php">button groups</a></li>
          <li><a href="./collections/modal.php">form elements</a></li>
          <li><a href="./components/el-avatar.php">contact app</a></li>
        </ul>
            ...
            <div class="card-body pd-25">
              <div class="media d-block d-sm-flex">
                ...
                <div class="media-body pd-t-25 pd-sm-t-0 pd-sm-l-25">
                  ...
                  <p class="mg-b-3 tx-color-02"><span class="tx-medium tx-color-01">Datamatics, Inc.</span>, Bay Area, San Francisco, CA</p>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-5 col-lg">
              ...
              <ul class="list-unstyled media-list mg-b-15">
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar avatar-online"><span class="avatar-initial rounded-circle bg-dark">S</span></div>
                  </a>
                  <div class="media-body pd-l-15">
                ...
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar avatar-online"><span class="avatar-initial rounded-circle bg-primary">I</span></div>
                  </a>
                  <div class="media-body pd-l-15">
                ...
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar avatar-offline"><img src="./assets/img/img8.jpg" class="rounded-circle" alt=""></div>
                  </a>
                  <div class="media-body pd-l-15">
                ...
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar avatar-online"><span class="avatar-initial rounded-circle bg-info">K</span></div>
                  </a>
                  <div class="media-body pd-l-15">
            ...
            <div class="col-sm-6 col-md-5 col-lg mg-t-40 mg-sm-t-0 mg-lg-t-40">
              ...
              <ul class="list-unstyled media-list mg-b-15">
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar avatar-online"><img src="./assets/img/img6.jpg" class="rounded-circle" alt=""></div>
                  </a>
                  <div class="media-body pd-l-15">
                ...
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar avatar-offline"><img src="./assets/img/img7.jpg" class="rounded-circle" alt=""></div>
                  </a>
                  <div class="media-body pd-l-15">
                ...
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar avatar-offline"><span class="avatar-initial rounded-circle bg-teal">R</span></div>
                  </a>
                  <div class="media-body pd-l-15">
                ...
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar avatar-online"><span class="avatar-initial rounded-circle bg-indigo">R</span></div>
                  </a>
                  <div class="media-body pd-l-15">
                ...
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar avatar-online"><span class="avatar-initial rounded-circle bg-gray-600">A</span></div>
                  </a>
                  <div class="media-body pd-l-15">
            ...
            <div class="col-sm-6 col-md-5 col-lg mg-t-40">
              ...
              <ul class="list-unstyled media-list mg-b-15">
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar"><img src="./assets/img/img21.jpg" class="rounded-circle" alt=""></div>
                  </a>
                  <div class="media-body pd-l-15">
                ...
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar"><img src="./assets/img/img22.jpg" class="rounded-circle" alt=""></div>
                  </a>
                  <div class="media-body pd-l-15">
                ...
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar"><img src="./assets/img/img24.jpg" class="rounded-circle" alt=""></div>
                  </a>
                  <div class="media-body pd-l-15">
                ...
                <li class="media align-items-center">
                  <a href="#">
                    <div class="avatar"><img src="./assets/img/img25.jpg" class="rounded-circle" alt=""></div>
                  </a>
                  <div class="media-body pd-l-15">
  ...
  <footer class="footer">
    <div>
      ...
      <span>Created by <a href="http://Datamatics.me/">Datamatics</a></span>
    </div>
    <div>
      <nav class="nav">
