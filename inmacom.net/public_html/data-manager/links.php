          ...
          <div class="col-lg-3">
            ...
            <form method="POST" id="flow_level_form">
              <div class="form-group">
                <label for="value" class="d-block">Link Name</label>
                <input name="value" id="link_name" type="number" step=".01" class="form-control" placeholder="Enter value">
              </div>
              <div class="form-group">
                <label for="value" class="d-block">URL</label>
                <input name="value" id="url" type="number" step=".01" class="form-control" placeholder="Enter value">
              </div>
