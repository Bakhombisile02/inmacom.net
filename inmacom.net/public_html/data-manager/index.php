          ...
          <div class="col-sm-5 col-md-4 col-lg-3 mg-t-10">
            <div class="card">
              ...
              <div class="card-footer bd-t-0 pd-t-0">
                <button class="btn btn-xs btn-block btn-outline-primary btn-uppercase tx-spacing-1">Learn More</button>
              </div><!-- card-footer -->
            </div><!-- card -->
          </div><!-- col -->
          ...
          <div class="col-lg-6 mg-t-10">
            <div class="card">
              <div class="card-header d-flex align-items-start justify-content-between">
                <h6 class="lh-5 mg-b-0">Very High Flow Levels</h6>
          ...
          <div class="col-lg-6 mg-t-10">
            <div class="card">
              <div class="card-header d-sm-flex align-items-start justify-content-between">
                <h6 class="lh-5 mg-b-0">Very Low Flow Levels</h6>
                <a href="#" class="tx-13 link-03">Mar 01 - Mar 20, 2019 <i class="icon ion-ios-arrow-down"></i></a>
              </div><!-- card-header -->
              <div class="card-body pd-y-15 pd-x-10">
                <div class="table-responsive">
