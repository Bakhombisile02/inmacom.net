    ...
    <div class="content-body">
      <div class="container pd-x-0">
          ...
          <div>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                ...
                <li class="breadcrumb-item active" aria-current="page">Manage Groundwater </li>
              </ol>
            </nav>
            <h4 class="mg-b-0 tx-spacing--1">Manage Groundwater Data</h4>
          </div>
        ...
        <div class="row row-xs">
          <div class="col-lg-3">
            <h6 class="mg-b-5">Add Groundwater Data</h6>
            <form method="POST" id="flow_level_form">
              <div class="form-group">
                <label for="station" class="d-block">Groundwater Station</label>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content tx-14">
            <div class="modal-header">
              <h6 class="modal-title" id="importModal">Import Groundwater Data</h6>
