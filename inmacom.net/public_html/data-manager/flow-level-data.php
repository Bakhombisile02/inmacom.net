  ...
  <div class="content ht-100v pd-0">
    ...
    <i data-feather="upload" class="wd-10 mg-r-5"></i> Export
        ...
        <div class="row row-xs">
          <div class="col-lg-3">
            <h6 class="mg-b-5">Add Flow Levels</h6>
            <form method="POST" id="flow_level_form">
              <div class="form-group">
                <label for="station" class="d-block">Guaging Station</label>
                <select name="station" id="station-list" class="form-control select2">
                  <option selected>Select Guaging Station</option>
                </select>
              </div>
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select name="unit" id="unit" class="form-control select2">
                    <option selected value="m^3/s ">m^3/s </option>
                  </select>
                </div>
  ...
  <div class="modal fade" id="import" tabindex="-1" role="dialog" aria-labelledby="importModal" aria-hidden="true">
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <a href="./templates/flow_levels.csv" target="_blank" class="btn btn-xs pd-x-15 btn-success btn-uppercase mg-l-5">
  ...
  <div class="modal fade" id="edit_form" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content tx-14">
          ...
          <form method="POST" id="flow_level_form">
            ...
            <div class="form-row">
              <div class="form-group col-md-7">
                <label for="value" class="d-block">Value</label>
                <input name="value" id="edit_value" type="number" step=".01" class="form-control" placeholder="Enter value">
              </div>
              <div class="form-group col-md-5">
                <label for="unit" class="d-block">Unit</label>
                <select name="unit" id="edit_unit" class="form-control select2" disabled>
                  <option selected value="m^3/s ">m^3/s </option>
                </select>
              </div>
              <div class="form-group col-md-12">
        ...
        <div class="modal-footer">
          <button class="btn btn-primary save-edit" type="submit">Save</button>
...
$(document).ready(function() {
    $('#export_button').on("click", function(e) {
        ...
        $.ajax({
            url: "../api/export-flow-levels.php",
            method: "GET",
            success: function(data, status, xhr) {
                // Check for a filename
                var disposition = xhr.getResponseHeader('Content-Disposition');
                var matches = /"([^"]*)"/.exec(disposition);
                var filename = (matches != null && matches[1] ? matches[1] : 'flow_level.csv');
