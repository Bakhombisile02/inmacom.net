          ...
          <div class="filemgr-sidebar-body">
            <div class="pd-t-20 pd-b-10 pd-x-10">
              ...
              <nav class="nav nav-sidebar tx-13">
                ...
                <a href="#" class="nav-link"><i data-feather="folder"></i> <span>Study Reports</span></a>
                <a href="#" class="nav-link"><i data-feather="folder"></i> <span>Guidelines</span></a>
                <a href="#" class="nav-link"><i data-feather="folder"></i> <span>Programs</span></a>
                <a href="#" class="nav-link"><i data-feather="folder"></i> <span>Agreements</span></a>
              </nav>
            </div>
            <div class="pd-10">
